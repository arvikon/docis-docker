...
The image builds on top of `ruby:2.6-alpine` with [Jekyll](https://jekyllrb.com/) 4.1.1, [HTMLproofer](https://github.com/gjtorikian/html-proofer) 3.15.3, [image_optim](https://github.com/toy/image_optim) 0.26.5, [Vale](https://errata-ai.gitbook.io/vale/) 2.3.1, and [yamllint](https://github.com/adrienverge/yamllint) 1.24.2.
